...
<head>
    ...
    <!--favicon-->
    <link rel="icon" href="{{ asset('assets/images/favicon-32x32.pn') }}g" type="image/png" />
    <!-- loader-->
                                ...
                                <div class="border p-4 rounded">
                                    <div class="text-center">
                                        ...
                                        {{-- <p>Don't have an account yet? <a
                                                href="{{ url('authentication-signup') }}">Sign
                                                up here</a>
                                        </p> --}}
                                        <p>Silahkan masukan username dan password yang sesuai!</p>
                                    </div>
                                    <div class="form-body">
