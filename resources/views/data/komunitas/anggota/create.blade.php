...
<div class="page-wrapper">
    <div class="page-content">
        ...
        <!--end breadcrumb-->
        <h6 class="mb-0 text-uppercase">Data Anggota Komunitas / Relawan {{ $komunitas->nama }}</h6>
        <hr />
                    ...
                    <div class="card-body">
                        <form action="" method="post">
                            ...
                            <div class="mb-3">
                                ...
                                <select name="tps_pemilih_id" id="" class="form-control select_partisipan">
                                </select>
                            </div>
                            <div class="mb-3">
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="status" id="anggota" value="A" {{
                                        old('status')=='A' ? 'checked' : '' }} checked required>
                            ...
                            <div class="text-end">
                                <a href="{{ url('komunitas/show/'.$komunitas->id) }}" type="button" class="btn" >Back</a>
