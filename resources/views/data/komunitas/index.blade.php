...
<div class="page-wrapper">
    <div class="page-content">
        ...
        <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
            ...
            <div class="ms-auto">
                <div class="btn-group">
                    <a href="{{ url('komunitas/create') }}" class="btn btn-primary">
        ...
        <!--end breadcrumb-->
        <h6 class="mb-0 text-uppercase">Data Komunitas / Relawan</h6>
        <hr />
        <div class="card">
            <div class="card-body">
                    ...
                    <table id="" class="table table-striped table-bordered partisipan" style="width:100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="align-middle">{{ count($item->anggota) }}</td>
                                <td class="text-center" style="width: 50px">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right dropdown-menu-lg-end">	
                                        <a class="dropdown-item" href="{{ url('komunitas/show/'.$item->id) }}">Anggota</a>
                                        <a class="dropdown-item" href="{{ url('komunitas/edit/'.$item->id) }}">Edit</a>
