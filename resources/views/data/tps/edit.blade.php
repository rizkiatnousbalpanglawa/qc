...
<div class="page-wrapper">
    <div class="page-content">
        ...
        <!--end breadcrumb-->
        <h6 class="mb-0 text-uppercase">Edit TPS</h6>
        <hr />
                ...
                <div class="card">
                    <div class="card-body">
                        <form action="" method="post">
                            ...
                            <div class="mb-3">
                                <label for="" class="form-label">Kabupaten / Kota ({{ $tps->village->district->regency->name }})</label>
                                <select name="" id="" class="form-control select_kab_kota">
                                    <option value="">{{ $tps->village->district->regency->name }}</option>
                                </select>
                                <input type="hidden" value="{{ $tps->regency_id }}" name="regency_id"
                                    class="regency_id">

                            </div>
                            <div class="mb-3">
                                <label for="" class="form-label">Kecamatan ({{ $tps->village->district->name }})</label>
                                <select class="form-control select_kecamatan" name="">
                                    <option value="">{{ $tps->village->district->name }}</option>
                                </select>
                                <input type="hidden" value="{{ $tps->district_id }}" name="district_id"
                                    class="district_id">
                            ...
                            <div class="mb-3">
                                ...
                                <select name="" class="form-control select_kelurahan" id="" required>
                                    <option value="{{ $tps->village_id }}">{{ $tps->village->name }}</option>
                                </select>
                                <input type="hidden" value="{{ $tps->village_id }}" name="village_id"
                                    class="village_id">
                            </div>
                            <div class="mb-3">
                                <label for="" class="form-label">Nomor TPS</label>
                                <input type="text" class="form-control" name="nomor_tps" value="{{ $tps->nomor_tps }}">
                            </div>
                            <div class="mb-3">
                                <label for="" class="form-label">Target</label>
                                <input type="text" class="form-control" name="target" value="{{ $tps->target }}"
                                    required>
                            </div>
                            <div class="text-end">
